    ...
    <div class="grid md:grid-cols-3 gap-6">
        ...
        <div class="md:col-span-2 space-y-4">
            ...
            <div class="border rounded-xl p-4 bg-white shadow-sm hover:shadow-md transition">
                <div class="flex justify-between items-start">
                    <div>
                        <h3 class="font-bold text-lg text-gray-800">General Admission</h3>
                        <p class="text-sm text-gray-500 mt-1">Tiket masuk event standar.</p>
                    </div>
                </div>
        ...
        <div>
            <div class="bg-white border rounded-2xl p-6 shadow-lg sticky top-24">
                ...
                <a href="{{ route('biodata', ['type' => 'event', 'id' => $id_item]) }}" 
...
<script>
    ...
    function calculateTotal() {
        ...
        document.getElementById('subtotal-price').innerText = formatter.format(totalPrice).replace(',00', '');
    }
</script>
