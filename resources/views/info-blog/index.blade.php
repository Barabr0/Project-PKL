    ...
    <div class="mb-10">
        ...
        <div class="grid md:grid-cols-3 gap-6">
            ...
            <div class="md:col-span-2 bg-white rounded-xl shadow">
                ...
                <div class="p-4">
                    <h3 class="font-bold">Artikel Utama Informasi</h3>
                </div>
            </div>
            ...
            <div class="space-y-3">
                ...
                <div class="flex gap-3 bg-white p-3 rounded-xl shadow">
                    ...
                    <p class="text-sm font-medium">Informasi {{$i}}</p>
                </div>
                @endfor
            </div>
    ...
    <div class="mb-10">
        ...
        <div class="grid md:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-xl shadow">
                ...
                <div class="p-3">
                    <p class="text-sm font-semibold">Informasi {{$i}}</p>
                </div>
            </div>
            @endfor
        </div>
